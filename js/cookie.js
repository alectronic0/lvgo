      ...
      translations: {
        en: {
          consentModal: {
            ...
            description:
              "We use cookies to enhance your experience, analyze site traffic, and serve tailored content. You can manage your preferences below. See our <a href='/policies/'>Privacy & Cookie Policy</a>.",
          ...
          preferencesModal: {
            ...
            sections: [
              ...
              },
              {
                ...
                description:
                  'Used to understand how visitors interact with the website, track metrics, and improve performance (e.g., Google Analytics).',
                linkedCategory: 'analytics',
              },
              {
                title: 'Marketing Cookies',
                description:
                  'Used to track visitors across websites to display relevant advertisements (e.g., Google Ads).',
    ...
    onChange: ({ changedCategories, cookie }) => {
      ...
      if (changedCategories.includes('analytics') && !cookie.categories.includes('analytics')) {
        ...
        if (domainSegments.length > 2) {
          ...
          document.cookie =
            '_ga=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/; domain=.' + rootDomain + ';';
        }
      }
    },
  });
